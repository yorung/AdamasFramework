...
layout (binding = 0, set = 1) uniform sampler2D sampler1;
layout (binding = 0, set = 2) uniform sampler2D sampler2;
layout (binding = 0, set = 3) uniform sampler2D sampler3;
layout (binding = 0, set = 4) uniform sampler2D sampler4;
layout (binding = 0, set = 5) uniform sampler2D sampler5;
