...
inline DXGI_FORMAT AFFormatToDXGIFormat(AFFormat InFormat)
{
	switch (InFormat)
	{
	case AFF_INVALID: return DXGI_FORMAT_UNKNOWN;
	case AFF_R8G8B8A8_UNORM: return DXGI_FORMAT_R8G8B8A8_UNORM;
	case AFF_R8G8B8A8_UNORM_SRGB: return DXGI_FORMAT_R8G8B8A8_UNORM_SRGB;
	case AFF_B8G8R8A8_UNORM: return DXGI_FORMAT_B8G8R8A8_UNORM;
	case AFF_R5G6B5_UINT: return DXGI_FORMAT_B5G6R5_UNORM;
	case AFF_R32G32B32A32_FLOAT: return DXGI_FORMAT_R32G32B32A32_FLOAT;
	case AFF_R16G16B16A16_FLOAT: return DXGI_FORMAT_R16G16B16A16_FLOAT;
	case AFF_D32_FLOAT: return DXGI_FORMAT_D32_FLOAT;
	case AFF_D32_FLOAT_S8_UINT: return DXGI_FORMAT_D32_FLOAT_S8X24_UINT;
	case AFF_D24_UNORM_S8_UINT: return DXGI_FORMAT_D24_UNORM_S8_UINT;
	case AFF_BC1_UNORM: return DXGI_FORMAT_BC1_UNORM;
	case AFF_BC2_UNORM: return DXGI_FORMAT_BC2_UNORM;
	case AFF_BC3_UNORM: return DXGI_FORMAT_BC3_UNORM;
	case AFF_R32G32_FLOAT: return DXGI_FORMAT_R32G32_FLOAT;
	case AFF_R32G32B32_FLOAT: return DXGI_FORMAT_R32G32B32_FLOAT;
	case AFF_R16_UINT: return DXGI_FORMAT_R16_UINT;
	case AFF_R16G16B16A16_UINT: return DXGI_FORMAT_R16G16B16A16_UINT;
	case AFF_R32_UINT: return DXGI_FORMAT_R32_UINT;
	case AFF_R32_FLOAT: return DXGI_FORMAT_R32_FLOAT;
	case AFF_R32_TYPELESS: return DXGI_FORMAT_R32_TYPELESS;
	case AFF_R8G8B8A8_UINT: return DXGI_FORMAT_R8G8B8A8_UINT;
	}
