...
inline VkFormat AFFormatToVkFormat(AFFormat InFormat)
{
	switch (InFormat)
	{
	case AFF_INVALID: return VK_FORMAT_UNDEFINED;
	case AFF_BC1_UNORM: return VK_FORMAT_BC1_RGBA_UNORM_BLOCK;
	case AFF_BC2_UNORM: return VK_FORMAT_BC2_UNORM_BLOCK;
	case AFF_BC3_UNORM: return VK_FORMAT_BC3_UNORM_BLOCK;
	case AFF_R8G8B8A8_UNORM: return VK_FORMAT_R8G8B8A8_UNORM;
	case AFF_B8G8R8A8_UNORM: return VK_FORMAT_B8G8R8A8_UNORM;
	case AFF_R16G16B16A16_FLOAT: return VK_FORMAT_R16G16B16A16_SFLOAT;
	case AFF_R32G32B32A32_FLOAT: return VK_FORMAT_R32G32B32A32_SFLOAT;
	case AFF_R32G32B32_FLOAT: return VK_FORMAT_R32G32B32_SFLOAT;
	case AFF_R32G32_FLOAT: return VK_FORMAT_R32G32_SFLOAT;
	case AFF_R8G8B8A8_UINT: return VK_FORMAT_R8G8B8A8_UINT;
	case AFF_D32_FLOAT: return VK_FORMAT_D32_SFLOAT;
	case AFF_R32_FLOAT: return VK_FORMAT_R32_SFLOAT;
	case AFF_R32_UINT: return VK_FORMAT_R32_UINT;
//	case AFF_R32_TYPELESS: return VK_FORMAT_R32_SFLOAT;
	case AFF_D24_UNORM_S8_UINT: return VK_FORMAT_D24_UNORM_S8_UINT;
	case AFF_D32_FLOAT_S8_UINT: return VK_FORMAT_D32_SFLOAT_S8_UINT;
	}
